// Tube ROM from Acorn External 65C02 Second Processor (Version 1.10)
//
// Note 1: Byte F818 has been changed by us from F0 to E0 for compatibility
// with the bank switch hardware (which uses locations FEE0-FEE7):
//   f817 a2 e0    ldx #E0
//   f819 bd ff fd lda FDFF,X
//   f81c 9d ff fd sta FDFF,X
//   f81f ca       dex
//   f820 d0 f7    bne F819
//
// Note 2: There are later versions from JGH:
//   http://mdfs.net/Software/Tube/6502/Bugfix.txt

const unsigned char tuberom_6502_extern_1_10[] = {
...
// Tube ROM from Acorn Internal 65C102 Second Processor (Version 1.10)
//
// Note 1: Byte F818 has been changed by us from F0 to E0 for compatibility
// with the bank switch hardware (which uses locations FEE0-FEE7):
//   f817 a2 e0    ldx #E0
...
const unsigned char tuberom_6502_intern_1_10 [] = {
  0xa2,0x00,0xbd,0x00,0xff,0x9d,0x00,0xff,0xca,0xd0,0xf7,0xa2,0x36,0xbd,0x80,0xff,
  0x9d,0x00,0x02,0xca,0x10,0xf7,0x9a,0xa2,0xe0,0xbd,0xff,0xfd,0x9d,0xff,0xfd,0xca,
  0xd0,0xf7,0xa0,0x00,0x84,0xf8,0xa9,0xf8,0x85,0xf9,0xb1,0xf8,0x91,0xf8,0xc8,0xd0,
  0xf9,0xe6,0xf9,0xa5,0xf9,0xc9,0xfe,0xd0,0xf1,0xa2,0x10,0xbd,0x59,0xf8,0x9d,0x00,
...
// JGH's updated 6502 Tube ROM (Version 1.12)
//   http://mdfs.net/Software/Tube/6502/Bugfix.txt
//
// Note 1: Byte F818 has been changed by us from F0 to E0 for compatibility
// with the bank switch hardware (which uses locations FEE0-FEE7):
...
const unsigned char tuberom_6502_intern_1_12_jgh[] = {
  ,
  ...
  
};
